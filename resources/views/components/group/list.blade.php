    ...
    <div class="flex-grow-1 ms-3">
        <header class="d-lg-flex">
            <section class="d-flex">
                <a href="{{ fs_route(route('fresns.group.detail', ['gid' => $group['gid']])) }}" class="text-nowrap overflow-hidden list-name fw-medium">{{ $group['gname'] }}</a>
                @if ($group['recommend'])
                    <img src="/assets/ZhijieWeb/images/icon-recommend.png" class="list-recommend ms-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Recommend" loading="lazy" alt="Recommend">
                @endif
